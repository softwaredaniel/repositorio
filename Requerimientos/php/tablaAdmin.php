...
<div class="container-fluid" >
		...
		<div style="text-align: center;">
			...
			<br>
			<div class="container-fluid">
			<dl class="rich-messages">
			<dt class="alert alert-success">
			<span class="rich-messages-marker">
				<span class="glyphicon glyphicon-ok">

			</span></span>
			<span class="alert-success">Bienvenido <?php echo $_SESSION['user'];?></span></dt></dl>	</div>
			<input type="text" class="form-control" name="txtnom" id="txtnom" value="" onkeyup="busqueda();" placeholder="buscar usuario">
		</br>
		<br>
		<div id="datos" width="100%">
...
<?php
		 ...
		 while ($mostrar=$resultado->fetch_array()){
		  array_push($temp,$mostrar['id_usuario']);
				...
				?>
					...
					<tbody>
						<?php foreach ($conexion->query('SELECT *FROM requerimiento_usuarios ORDER BY `requerimiento_usuarios`.`id` DESC ') as $row){
						$id=$row['id'];	
		   ...
		   <td> <span ><a class="btn btn-default"href="formatoAdmin.php?id=<?php echo $id; ?>">Viabilidad</a></span></td>
		...
		<footer class="panel-footer">
			<p align="center">®Jose Daniel Solano Manosalva</p>
		</footer>
			</html>
